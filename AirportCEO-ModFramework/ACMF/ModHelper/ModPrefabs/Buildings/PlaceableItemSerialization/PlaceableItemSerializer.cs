...
namespace ACMF.ModHelper.ModPrefabs.Buildings.PlaceableItemSerialization
{
    internal static class PlaceableItemSerializer
    {
        ...
        internal static void SerializePlaceableItemsUsingCustomSerializationSystem(string savePath, List<PlaceableItem> itemsUsingCustomSerializationSystem)
        {
            ...
            {
                if (ActiveBuildingCreators.HasCreatorFromEnum(item.itemType) == false)
                    continue;

                Utilities.Logger.Print($"Modded Placeable Item Serializing {item}...");
                IACMFPlaceableItemCustomSerializationSystem serializationSystem = ActiveBuildingCreators.GetCreatorFromEnum(item.itemType) as IACMFPlaceableItemCustomSerializationSystem;
        ...
        internal static void DeserializePlaceableItemsUsingCustomSerializationSystem(string savePath)
        {
            ...
            {
                if (ActiveBuildingCreators.HasCreatorFromEnum(pis.itemType) == false)
                    continue;

                IACMFPlaceableItemCustomSerializationSystem serializationSystem = ActiveBuildingCreators.GetCreatorFromEnum(pis.itemType) as IACMFPlaceableItemCustomSerializationSystem;
