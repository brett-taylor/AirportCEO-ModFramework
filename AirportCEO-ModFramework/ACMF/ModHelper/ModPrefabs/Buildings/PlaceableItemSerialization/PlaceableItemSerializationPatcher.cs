        ...
        public static class PlaceableItemSerializerPatcher
        {
            ...
            public static bool Prefix(bool _debugPrints, string _savePath)
            {
                ...
                foreach (PlaceableItem pl in originalItemList)
                {
                    ...
                    bool isModded = ActiveBuildingCreators.HasCreatorFromEnum(pl.itemType);
                    bool usesCustomSerializer = ActiveBuildingCreators.GetCreatorFromEnum(pl.itemType) is IACMFPlaceableItemCustomSerializationSystem;
