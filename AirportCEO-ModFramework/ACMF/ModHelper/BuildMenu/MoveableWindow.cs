...
/**
 *  Credit: MMOERPG
 *  https://forum.unity.com/threads/drag-window-script-with-window-clamped-within-canvas.453340/
 */
namespace ACMF.ModHelper.BuildMenu
{
    public class MoveableWindow : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
